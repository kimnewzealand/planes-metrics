...
plt.show()
# It appears that the airports are distributed across the US
...
# The primary key on the flights_df appears to be a combination of columns: flight + departure time dimension (+ carrier?)
# %%
